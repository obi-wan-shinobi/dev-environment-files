...
export PATH="$HOME/neovim/bin:$HOME/bin:/usr/local/bin:/usr/local/go/bin:$HOME/go/bin/:/usr/local/texlive/2024/bin/x86_64-linux:$HOME/.local/bin:$PATH"

# Path to your oh-my-zsh installation.
export ZSH="$HOME/.oh-my-zsh"

# Need to set the TERM variable so kitty works well with ssh
...
# opencode
export PATH=/home/shreyas/.opencode/bin:$PATH
